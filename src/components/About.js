...
export default function About(props) {
    ...
    return <div classNameName='container' style={{color: props.mode === 'dark'?'white':'#042743'}}>
    ...
    TextUtils gives you a way to analyze your text quickly and effeciently. Be it word count or character count.
    </div>
    </div>
    </div>
    <div className="accordion-item">
    ...
    <div className="accordion-body" style={myStyle}>
    This word counter software works in any web browsers such as Chrome, Firefox, Microsoft Edge, Safari, Opera. It suits to count characters in facebook, blog, books, excel document, pdf ddocument, essays and etc.
    </div>
    </div>
    </div>
    </div>
